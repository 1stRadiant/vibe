...
function bindEventListeners() {
    ...
    // START OF CHANGE: Add listeners for AI Structure Update modal
    ...
    window.addEventListener('click', (event) => {
        ...
        if (event.target === aiStructureModal) closeAiStructureModal(); // Close on backdrop click
    });
...
function resetToStartPage() {
    ...
    if (projectInstructionsInput) projectInstructionsInput.value = ''; // Clear new input
