...
function renderEditor(node) {
    ...
    // START OF CHANGE: Make the whole node container draggable for better UX
    ...
    // START OF CHANGE: Removed draggable="true" from the span, now handled by container
    nodeEl.innerHTML = `
...
function handleDragStart(event) {
    // START OF CHANGE: Check if the drag started on the handle
    ...
    // START OF CHANGE: Use requestAnimationFrame for smoother class addition
...
function handleDragOver(event) {
    event.preventDefault();
    // START OF CHANGE: Stop propagation to prevent nested drop targets from interfering
...
function handleDrop(event) {
    event.preventDefault();
    // START OF CHANGE: Stop propagation
    event.stopPropagation();
    // END OF CHANGE
