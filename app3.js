...
async function handleFileUpload() {
    ...
    reader.onload = async (event) => {
        ...
        // Reset the tree to a blank state, as it no longer reflects the code
        vibeTree = JSON.parse(JSON.stringify(initialVibeTree));
        refreshAllUI(); // This will clear the vibe editor and preview
        resetHistory();
        
        // Switch to the code editor so the user can see the uploaded code
        switchToTab('code');
        
        console.log(`HTML project '${currentProjectId}' loaded into editor. Ready for processing.`);
        alert("File content loaded into the 'Code' tab. Click 'Update Vibe Tree from Code' to process it.");
        autoSaveProject(); // Save the blank project state under the new ID
    };
...
async function handleZipUpload() {
    ...
    try {
        ...
        console.log(`ZIP project '${currentProjectId}' loaded into editor. Ready for processing.`);
        alert("ZIP content loaded into the 'Code' tab. Click 'Update Vibe Tree from Code' to process it.");
        autoSaveProject(); // Save the blank project state under the new ID
